...
from src.bot.handlers.analyze import trigger_analysis_flow, get_default_period
...
async def menu_message_handler(
    ...
    if my_analysis_match:
        ...
        context.user_data.pop("state", None)
        await trigger_analysis_flow(update, context, username, get_default_period())
        return
    ...
    if state == "awaiting_bind":
        ...
        await trigger_analysis_flow(update, context, cleaned, get_default_period())